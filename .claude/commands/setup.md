...
```bash
npm exec --yes --package @takahiro-shimizu-1/automation-runner@0.1.24 -- automation-runner setup --apply --json
```
...
- `gh secret list`
- `docker info`
- `npm exec --yes --package @takahiro-shimizu-1/automation-runner@0.1.24 -- automation-runner setup --apply`
